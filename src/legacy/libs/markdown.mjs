...
const markdownManager = {
  ...
  parseMarkdown: function (markdownText, type = 'result') {
    ...
    for (const item in markdownManager.values) {
      if (
        typeof markdownManager.values[item][type] === 'string' ||
        typeof markdownManager.values[item][type] === 'function'
      ) {
        htmlText = htmlText.replace(
          markdownManager.values[item].regex,
          markdownManager.values[item][type],
        );
      }
    }
