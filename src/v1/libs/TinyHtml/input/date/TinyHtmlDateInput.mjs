...
class TinyHtmlDateInput extends TinyHtmlInput {
  ...
  constructor({
    ...
    super({ value, name, placeholder, type: 'date', tags, mainClass, readonly, required });
    if (min !== undefined && typeof min !== 'number')
      throw new TypeError("TinyHtmlInput: 'min' must be a number.");
    if (max !== undefined && typeof max !== 'number')
      throw new TypeError("TinyHtmlInput: 'max' must be a number.");
    if (step !== undefined && typeof step !== 'number')
      throw new TypeError("TinyHtmlInput: 'step' must be a number.");
