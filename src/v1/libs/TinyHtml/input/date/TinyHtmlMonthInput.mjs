...
class TinyHtmlMonthInput extends TinyHtmlInput {
  ...
  constructor({
    ...
    super({ value, name, placeholder, type: 'month', tags, mainClass, readonly, required });
    if (min !== undefined && typeof min !== 'number')
      throw new TypeError("TinyHtmlMonthInput: 'min' must be a number.");
    if (max !== undefined && typeof max !== 'number')
      throw new TypeError("TinyHtmlMonthInput: 'max' must be a number.");
    if (step !== undefined && typeof step !== 'number')
      throw new TypeError("TinyHtmlMonthInput: 'step' must be a number.");
