...
class TinyHtmlWeekInput extends TinyHtmlInput {
  ...
  constructor({ value, min, max, name, placeholder, tags = [], mainClass = '' }) {
    ...
    if (typeof min !== 'number') throw new TypeError("TinyHtmlWeekInput: 'min' must be a number.");
    if (typeof max !== 'number') throw new TypeError("TinyHtmlWeekInput: 'max' must be a number.");
